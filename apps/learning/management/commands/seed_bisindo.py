...
VOCABULARY = [
    ...
    ("Maaf", "Isyarat untuk meminta maaf atau memohon pengertian.", "https://youtu.be/yiNQZ4qP-gQ?si=6I7ak9dHztI91uW0", 0),
    ("Tolong", "Isyarat penting untuk meminta bantuan dengan sopan.", "https://youtu.be/yAXaeSnPQao?si=4PET6NWv03GLoyxL", 0),
    ("Nama", "Digunakan saat memperkenalkan nama.", "https://www.youtube.com/watch?v=r4QneN0IK5c", 0),
    ("Saya", "Kata ganti orang pertama untuk merujuk diri sendiri.", "https://www.youtube.com/watch?v=xnxydJPDD1M&list=PLfsmXCUc8kvHMpSJI4aYLID1qVIAh1GCZ&index=2", 0),
    ("Kamu", "Kata ganti orang kedua saat menyapa lawan bicara.", "https://www.youtube.com/watch?v=xnxydJPDD1M&list=PLfsmXCUc8kvHMpSJI4aYLID1qVIAh1GCZ&index=2", 0),
    ("Senang Bertemu", "Ungkapan perkenalan untuk menyampaikan senang bertemu seseorang."),
    ("Aku", "Kata ganti orang pertama informal untuk merujuk diri sendiri.", "https://www.youtube.com/watch?v=xnxydJPDD1M&list=PLfsmXCUc8kvHMpSJI4aYLID1qVIAh1GCZ&index=2", 0),
    ("Dia", "Kata ganti orang ketiga tunggal untuk merujuk seseorang.", "https://www.youtube.com/watch?v=xnxydJPDD1M&list=PLfsmXCUc8kvHMpSJI4aYLID1qVIAh1GCZ&index=2", 0),
    ("Kami", "Kata ganti orang pertama jamak, tidak termasuk lawan bicara.", "https://www.youtube.com/watch?v=xnxydJPDD1M&list=PLfsmXCUc8kvHMpSJI4aYLID1qVIAh1GCZ&index=2", 0),
    ("Kalian", "Kata ganti orang kedua jamak saat menyapa lebih dari satu orang.", "https://www.youtube.com/watch?v=xnxydJPDD1M&list=PLfsmXCUc8kvHMpSJI4aYLID1qVIAh1GCZ&index=2", 0),
    ...
    ("Selamat Siang", "Sapaan umum untuk waktu tengah hari hingga sore.", "https://www.youtube.com/watch?v=xnxydJPDD1M&list=PLfsmXCUc8kvHMpSJI4aYLID1qVIAh1GCZ&index=2", 0),
    ("Selamat Sore", "Sapaan untuk menyapa di waktu sore hari.", "https://www.youtube.com/watch?v=xnxydJPDD1M&list=PLfsmXCUc8kvHMpSJI4aYLID1qVIAh1GCZ&index=2", 0),
    ("Selamat Malam", "Sapaan untuk menyapa atau berpamitan di malam hari.", "https://www.youtube.com/watch?v=xnxydJPDD1M&list=PLfsmXCUc8kvHMpSJI4aYLID1qVIAh1GCZ&index=2", 0),
    ("Angka", "Pelajaran ringkasan angka dasar dalam BISINDO.", "https://www.youtube.com/watch?v=5UN60jB4eKg", 0),
]
